          ...
          <div className="col-span-12  backdrop-blur-lg py-14 sm:py-8 ">
            <div className="flex space-x-10 sm:flex-row flex-col">
              <div className="lg:w-3/5">
                ...
                <div className="m-0 text-[#3e4246]/85 px-8  sm:px-0 text-base min-[500px]:mb-4 sm:leading-[27px] pb-8 sm:pb-0">
                  Our philosophy is simple: <span className="italic">focus on your business, and we’ll handle your website.</span> From hosting to design, we provide unlimited edits, 24/7 support, top Google Page Speed scores, and valuable analytics. Let’s get the ball rolling on your next project—
                  <span onClick={handleClick} className='hover:underline cursor-pointer'>
                    <span className="inline-flex text-blue-400 items-center">join us today!
