...
export default function MainNav() {
  return (
    ...
    <div className="mx-auto w-full rounded-full">
      <div className="relative flex h-16 justify-between max-w-[68rem] mx-auto">
        <div className="relative z-10 flex">
          <div className="hidden lg:flex flex-shrink-0 items-center">
            <div className="flex items-center gap-1 uppercase text-sky-800 text-sm tracking-wide font-bold space-x-16  mr-5">
        ...
        <div className="hidden lg:relative lg:z-10 lg:flex lg:items-center">
          <div className="flex items-center gap-1 uppercase text-sky-800 text-sm tracking-wide font-bold space-x-16  ml-5">
