    ...
    <div className="w-full">
      <svg className="drop-shadow w-96 -scale-x-100" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 364.7 252.27">
        <defs>
          ...
          <linearGradient id="linear-gradient-2" x1="169.29" y1="158.63" x2="247.42" y2="406.75" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-3" x1="188.89" y1="70.29" x2="141.12" y2="393.21" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-4" x1="181.1" y1="118.92" x2="238.34" y2="383.44" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-5" x1="141.52" y1="115.44" x2="104.71" y2="364.26" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-6" x1="140.64" y1="230.56" x2="121.06" y2="280.93" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-7" x1="227.27" y1="31.41" x2="311.18" y2="764.24" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-8" x1="270.38" y1="119.43" x2="294.31" y2="236.55" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-9" x1="215.42" y1="160.73" x2="348.7" y2="150.41" xlinkHref="#linear-gradient" />
          <linearGradient id="linear-gradient-10" x1="208.92" y1="79.5" x2="330.56" y2="186.12" xlinkHref="#linear-gradient" />
        </defs>
        <title>8</title>
        <path
        ...
        <path d="M71.44,223.36l98.84-43a11.86,11.86,0,0,1,6.93-1.15L299.46,189.6c2.34.33,1.92,10.39,0,12l-72.2,61.46a18.15,18.15,0,0,1-16.17,4.06L72.31,233.37C70.54,232.94,69.78,224.18,71.44,223.36Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        ...
        <path d="M299.49,194.47l-72.2,61.46A18.13,18.13,0,0,1,211.12,260L72.31,226.24c-1.77-.43-2-3.23-.35-4.06L110,200.71l10-5.62L150.41,178a11.85,11.85,0,0,1,6.93-1.15l140.92,12.26C300.6,189.39,301.38,192.86,299.49,194.47Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        ...
        <path d="M153.29,176.79l145.38,20.69a4.22,4.22,0,0,0,4.72-3.35L324.13,89.4a8.11,8.11,0,0,0-7.25-9.66L173.31,67.15a8.11,8.11,0,0,0-8.77,7.2Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        ...
        <path d="M284,105,181.31,94.31l2.33-13L286.36,92a6.21,6.21,0,0,1,5.72,7.24h0A7.4,7.4,0,0,1,284,105Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        <polygon points="156.6 53.08 239.55 61.73 241.88 48.69 158.93 40.03 156.6 53.08" fill="#fff" opacity="0.56" />
        <ellipse cx="277.87" cy="96.99" rx="3.41" ry="3.13" transform="translate(-40.95 66.66) rotate(-21.36)" fill="none" stroke="#fff" strokeMiterlimit="10" strokeWidth="1.04" />
        <path d="M280,102.42c-.07-.17-.94-2.54-.94-2.54" transform="translate(-24.71 -41.23)" fill="none" stroke="#fff" strokeMiterlimit="10" strokeWidth="1.04" />
        <polygon points="258.3 82.59 153.5 71.37 154.05 69.65 258.84 80.87 258.3 82.59" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
        <polygon points="190.76 68.83 155.37 64.64 156.09 61.56 191.49 65.42 190.76 68.83" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
        <polygon points="257 89.52 152.2 78.3 152.74 76.58 257.54 87.8 257 89.52" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
        <g opacity="0.66" style={{ isolation: "isolate" }}>
          <polygon points="185.13 96.51 149.74 92.33 150.46 89.24 185.86 93.1 185.13 96.51" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
          <polygon points="252.39 110.89 147.59 99.67 148.14 97.94 252.94 109.17 252.39 110.89" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
          <polygon points="250 118.91 145.2 107.69 145.75 105.97 250.54 117.19 250 118.91" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
        </g>
        <polygon points="247.97 136.24 143.28 122.57 143.82 120.86 248.51 134.53 247.97 136.24" fill="#1eb2ff" opacity="0.18" style={{ isolation: "isolate" }} />
        ...
        <path d="M214.84,165.9a9,9,0,0,0,1.16,4.15l2.64,5.64a13.74,13.74,0,0,0,2.34,3.85,7,7,0,0,0,6,2,3,3,0,0,0,2.46-1.6c.45-1.17-.31-2.42-.92-3.51-1.64-2.93-2.34-6.27-3.12-9.53-.6-2.54-1.82-6.12-4.92-6.48C217.74,160.1,215,163.23,214.84,165.9Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        <path d="M241.74,152.76s-22.66-20.73-44.81,0c0,0,17.12-2.21,22.4,7.22Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        <path d="M251,171.71s-1.08,30.7-31.39,32c0,0,13.57-10.67,10.54-21.05Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        ...
        <circle cx="242.33" cy="109.06" r="8.22" fill="#1eb2ff" />
        ...
        <path d="M256.1,129.67l.62.38c.09,0,.18.1.21.2a.41.41,0,0,1,0,.22l-.41,1.82a5.94,5.94,0,0,1-.86,2.29c-.24.33-2-.89-2.3-1.05a7.54,7.54,0,0,1-1.93-1.85,3.07,3.07,0,0,1-.55-1,4.11,4.11,0,0,1,.4-2.71c.7-1.37,1.88-.69,2.77.15A13.71,13.71,0,0,0,256.1,129.67Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        ...
        <path d="M251.81,129.48s3.92,5.53,4.49,5.86-3.52,4.35-3.52,4.35-4.74-5.13-5.29-7.75S249.39,127.52,251.81,129.48Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
        <path
        ...
        <rect x="260.99" y="124.06" width="1.44" height="3.94" rx="0.5" transform="translate(3.49 -87.98) rotate(10.78)" fill="#1eb2ff" />
        ...
        <path d="M259.61,122.2l-.1,1.14a.59.59,0,0,0,.44.7,15.55,15.55,0,0,1,5.53,1.44,19.29,19.29,0,0,1,2.68,1.82c.34.27.83,0,.91-.58l.89-6c.08-.53-.3-.9-.7-.7-1.67.85-5.42,2.41-8.89,1.45C260,121.38,259.65,121.73,259.61,122.2Z" transform="translate(-24.71 -41.23)" fill="#1eb2ff" />
