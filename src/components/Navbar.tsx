...
const Navbar = async () => {
  ...
  return (
    <div className=" border-slate-100/90 z-50 top-0 inset-x-0 bg-white/80 backdrop-blur fixed sm:h-[4.4rem] h-[3.5rem]">
      {/* <ProgressBar /> */}
      <header className="px-4 sm:px-8">
        <MaxWidthWrapper>
          <div className="">
            <div className="flex sm:h-[4.4rem] h-[3.5rem] items-center justify-between">
