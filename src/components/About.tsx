...
const UserCard = () => {
  return (
    <div className="sm:w-full bg-white sm:mx-0 sm:mx-4 h-[29rem]  transform duration-200 easy-in-out">
      ...
      <div className="sm:pb-6 mx-auto flex justify-center">
        <div className="text-center px-14">
          <h2 className="text-[#3e4246] font-neue-kabel text-xl sm:text-3xl font-normal">Steven Keezer</h2>
          <p className="mt-2 text-slate-500 text-xs mt-4 sm:text-sm max-w-sm">Software Engineer, Collegiete athlete, musician, runner, cyclist and electronics nerd.</p>
        </div>
      </div>
...
export const About = () => {
  return (
    <div className="pb-8 mx-auto px-4 sm:px-0 md:max-w-full lg:py-36 overflow-y-hidden overflow-x-hidden">
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-start pt-8 sm:pt-0 xl:pr-0">
          <div className="max-w-xl mb-6">
            {/* <div className="flex text-[#2a7ec8] font-neue-kabel font-bold tracking-wide uppercase mb-3 sm:mb-6 text-xs sm:text-sm rounded-full bg-teal-accent-400">
              WHO WE ARE
            </div> */}
            <h2 className="max-w-2xl mb-4 sm:mb-14 font-neue-kabel font-normal text-2xl tracking-tight text-[#3e4246] sm:text-5xl sm:leading-none">
              Going the extra mile
            </h2>
            <p className="text-sm sm:text-base text-[#3e4246]/80">
              <span className="text-sm sm:text-base text-[#3e4246]/80">
