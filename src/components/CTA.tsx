          ...
          <div className="py-16 mx-auto">
            <div className="lg:flex lg:items-center">
              ...
              <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                {/* <img className="w-[28rem] h-[28rem] object-cover xl:w-[30rem] xl:h-[30rem] rounded-full" src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" alt="" /> */}
              </div>
            </div>
          </div>
        </MaxWidthWrapper>
